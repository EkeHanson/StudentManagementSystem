      ...
      <Container maxWidth="xl">
        ...
        >
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            >
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Features</Link>
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Pricing</Link>
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Solutions</Link>
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Integrations</Link>
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Mobile App</Link>
            </Stack>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            >
              ...
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Careers</Link>
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Partners</Link>
              <Link href="/contact" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Contact Us</Link>
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.9rem' }}>Newsroom</Link>
            </Stack>
          </Grid>
        ...
        >
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.8rem' }}>Privacy Policy</Link>
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.8rem' }}>Terms of Service</Link>
              <Link href="#" color="inherit" underline="hover" sx={{ fontSize: '0.8rem' }}>Cookie Policy</Link>
            </Stack>
          </Grid>
